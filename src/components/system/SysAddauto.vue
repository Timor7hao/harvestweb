...
<script>
  import AddHarJpaper from '../harvest/AddHarJpaper'
  import AddHarMpaper from '../harvest/AddHarMpaper'
  import AddHarPatent from '../harvest/AddHarPatent'
  import AddHarProject from '../harvest/AddHarProject'
  import AddHarSubject from '../harvest/AddHarSubject'
  import AddHarSoftware from '../harvest/AddHarSoftware'
  import AddHarAffairs from '../harvest/AddHarAffairs'
